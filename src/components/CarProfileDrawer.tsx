...
const CarProfileDrawer: React.FC<CarProfileDrawerProps> = ({ updatedVehicles }) => {
  ...
  return (
    <article>
      {isOpen && <div className="fixed " onClick={toggleDrawer}></div>}
      <div className=" flex  ">
        <div className=" flex flex-row ">
          <div className="cursor-pointer">
            {" "}
            <IoArrowBack size={24} onClick={toggleDrawer} />
          </div>
          <div className="flex justify-center ">
            <div className="flex flex-col justify-center items-center max-w-[451px] w-full ">
              ...
              >
                Here’s a quick summary of your vehicle’s key details. Keep this
                information up to date to stay in sync with your account.
              </p>
            </div>
          </div>
        </div>
                  ...
                  <div className="flex flex-col w-full max-w-[140px] self-end mt-[-14px]">
                    {isOpenVehicle && (
                      <div
                        ...
                        className={`w-full rounded-[8px] bg-[#FFFFFF] pl-[4px] py-[8px] border border-[#D0D5DD] mt-[-1px] transition-all duration-500 ease-in-out transform ${
                          isOpenVehicle
                  ...
                  <div className="py-[4px] px-[8px]">
                    ...
                    >
                      <div className="flex items-center">
                        ...
                        <span className="text-[13px]">Make</span>
                      </div>
                      <span className="text-[#212121] text-[13px]  self-end">
                        {/* {car.thirdPartyNominate} */}
                        Toyota
