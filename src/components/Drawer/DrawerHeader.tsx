...
const DrawerHeader = ({
  ...
  return (
    <div className={`flex  pt-[60px] items-center justify-between px-2 md:px-0`}>
...
//       <h1
//         className={`text-[24px] leading-none md:text-[32px] text-center text-[#000000] lg:text-[32px] ${className} ${groteskTextMedium.className}`}
//       >
//         {title}
//       </h1>
//       {subTitle && (
//         <p
//           className={`text-[#667185] text-center leading-none ${groteskText.className}`}
//         >
//           {subTitle}
//         </p>
//       )}
