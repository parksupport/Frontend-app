    ...
    <div className=" mb-[300px] ">
      ...
      <form className="pt-5 md:pt-10 px-[20px] md:mx-auto ">
        <div className="flex flex-col gap-4 items-center ">
          ...
          {(userRole === "User" ? UserInputFields : CompanyInputFields).map(
            (field) => (
              <InputField
                ...
                variant="individual"
                className={` ${groteskText.className} w-full md:w-[65%] `}
              />
            )
          )}
          <div className="flex items-start ml-1 -mt-3 space-x-2 w-full md:w-[65%]">
            <input
              type="checkbox"
            ...
            <label
              ...
              className={` ${groteskText.className} text-[16px] text-[#667185] cursor-pointer`}
            >
          ...
          <Button
            variant="quinary"
            className="py-[10px] px-[12px] w-full md:w-[65%]"
