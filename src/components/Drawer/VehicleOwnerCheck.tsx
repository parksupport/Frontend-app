    ...
    <div className="flex  flex-col items-center justify-center bg-white p-4">
      ...
      <div className="flex mt-8 space-x-4 border p-2 rounded-[6px] bg-[#F1F4FD]">
        <button
          ...
          className=" rounded-[8px] px-12 py-2  text-blue-600  hover:bg-blue-700 hover:text-white transition"
        >
          Yes I am
        </button>
        <button
          onClick={OwnerInfoDrawer}
          className="rounded-[8px]  px-8 py-2 text-blue-600  hover:bg-blue-700 hover:text-white  transition"
        >
          No I am not
        </button>
      </div>
