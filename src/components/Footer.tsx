...
export default function Footer() {
  return (
    <footer className="bg-[#DFE7FA] text-[#475367] ">
      <div className=" container mx-auto pt-6 border-t border-blue-200 flex flex-col md:flex-row items-center justify-between md:space-x-6 md:pb-8 md:pt-[100px]">
        <div className="flex flex-col md:flex-row items-center md:space-x-6 w-full justify-between ">
          <div className="w-[99px] h-[28px]  order-1">
            <Logo />
          </div>

          <nav className="flex space-x-20 order-2 justify-between md:text-[20px]">
      ...
      <div className="container mx-auto pt-6 pb-5 border-t border-[#3957D7] text-center text-sm text-gray-500 ">
        <div className="pb-5 flex gap-[20px] text-[#1D224E] justify-center text-2xl md:hidden space-x-4 order-3">
          <FontIcon icon={faTwitter} url="#" />
          <FontIcon icon={faFacebook} url="#" />
          <FontIcon icon={faInstagram} url="#" />
          <FontIcon icon={faGithub} url="#" />
        </div>
        <div className=" flex flex-col md:flex-row justify-between items-center  md:pt-4">
